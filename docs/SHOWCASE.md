...
The hero slideshow at the top of the README is built from real window grabs by
the scripts in [`docs/tools/`](tools/) — see that folder's README to rebuild it.

| File | Size | Use it for |
|---|---|---|
| [`showcase-slideshow.webp`](assets/showcase-slideshow.webp) | 1280×896 | The README hero — animated, cross-fading |
| [`showcase-slideshow.png`](assets/showcase-slideshow.png) | 1280×896 | APNG fallback for the same slideshow (hard cuts) |
| [`showcase-1-desktop.png`](assets/showcase-1-desktop.png) | 1600×1120 | Slide 1 still — the desktop binding editor |
| [`showcase-2-virtual-menus.png`](assets/showcase-2-virtual-menus.png) | 1600×1120 | Slide 2 still — virtual menus + live preview |
| [`showcase-3-keyboard.png`](assets/showcase-3-keyboard.png) | 1600×1120 | Slide 3 still — the OSK in the Hatsune Miku skin |

Serve the animation through `<picture>` so browsers without animated-WebP
support still get something moving:
...
Every graphic below is a hand-written, self-contained SVG in [`docs/assets/`](assets/).
