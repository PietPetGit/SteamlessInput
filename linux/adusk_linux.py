...
and ViGEm virtual gamepad are NOT ported  the rest of SteamlessInput
...
def _watch_loop(args):
    ...
    print("SteamlessInput (Linux) running.")
...
def main():
    parser = argparse.ArgumentParser(
        description="SteamlessInput on-screen keyboard (Linux)."
    )
    parser.add_argument(
