"""Standalone rumble tester for SteamlessInput's gamepad-mode rumble.
...
Setup:
  1. Run SteamlessInput and set tray menu -> Gamepad Mode -> Always On
...
def main():
    if len(sys.argv) > 1:
        ...
        if idx is None:
            raise SystemExit(
                "No XInput controller found. Is SteamlessInput running with "
